...
" An extension for telescope allows to find results from coc.nvim
" (ex: fuzzy search definitions, references, etc... from coc)
...
source ~/.config/nvim/configs/calendar.vim
